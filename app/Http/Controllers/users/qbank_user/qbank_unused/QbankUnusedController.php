...
namespace App\Http\Controllers\users\qbank_user\qbank_unused;
...
class QbankUnusedController extends Controller
{
    public function loadUnusedSystems(Request $request)
    {
    ...
    $corrects = QbankUnused::where('id', $userId)
