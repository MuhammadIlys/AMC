...
namespace App\Http\Controllers\users\qbank_user\qbank_corrects;
...
class QbankCorrectsController extends Controller
{
    public function loadCorrectSystems(Request $request)
    {
