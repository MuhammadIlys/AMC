...
namespace App\Http\Controllers\users\qbank_user\qbank_omitted;
...
class QbankOmittedController extends Controller
{
    public function loadOmittedSystems(Request $request)
    {
    ...
    $corrects = QbankOmitted::where('id', $userId)
