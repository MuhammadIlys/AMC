...
namespace App\Http\Controllers\users\qbank_user\qbank_marked;
...
class QbankMarkedController extends Controller
{
    public function loadMarkedSystems(Request $request)
    {
    ...
    $corrects = QbankMarked::where('id', $userId)
