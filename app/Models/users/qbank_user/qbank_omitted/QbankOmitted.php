...
namespace App\Models\users\qbank_user\qbank_omitted;
...
class QbankOmitted extends Model
{
    use HasFactory;

    protected $table = 'qbank_omitted';
    protected $primaryKey = 'omitted_question_id';
