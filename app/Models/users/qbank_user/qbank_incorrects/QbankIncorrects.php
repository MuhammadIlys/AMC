...
namespace App\Models\users\qbank_user\qbank_incorrects;
...
class QbankIncorrects extends Model
{
    use HasFactory;

    protected $table = 'qbank_incorrects';
    protected $primaryKey = 'incorrect_question_id';
