...
namespace App\Models\users\qbank_user\qbank_last_incorrect_fetch_question;
...
class LastIncorrectFetchedQuestion extends Model
{
    use HasFactory;

    protected $table = 'last_incorrect_fetched_questions';
