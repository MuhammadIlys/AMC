...
namespace App\Models\users\qbank_user\qbank_last_omitted_fetch_question;
...
class LastOmittedFetchedQuestion extends Model
{
    use HasFactory;

    protected $table = 'last_omitted_fetched_questions';
