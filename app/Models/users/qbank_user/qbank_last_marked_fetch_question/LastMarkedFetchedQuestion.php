...
namespace App\Models\users\qbank_user\qbank_last_marked_fetch_question;
...
class LastMarkedFetchedQuestion extends Model
{
    use HasFactory;

    protected $table = 'last_marked_fetched_questions';
