...
namespace App\Models\users\qbank_user\qbank_corrects;
...
class QbankCorrects extends Model
{
    use HasFactory;


    protected $table = 'qbank_corrects';
    protected $primaryKey = 'correct_question_id';
