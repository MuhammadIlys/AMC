...
namespace App\Models\users\qbank_user\qbank_last_unused_fetch_question;
...
class LastUnusedFetchedQuestion extends Model
{
    use HasFactory;

    protected $table = 'last_unused_fetched_questions';
