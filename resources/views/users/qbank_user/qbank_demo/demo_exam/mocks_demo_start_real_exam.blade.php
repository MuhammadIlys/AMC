...
<script>
    ...
    function startTimer() {
        // Retrieve remaining time from localStorage or set to default (4500 seconds)
        countdown = localStorage.getItem('timer') || 4500;
    ...
    function handleMocksEnd(){
        ...
        countdown = 4500; // Assuming 4500 is the default timer value


        var baseUrl = "{{ url('/') }}";
        var url = baseUrl + '/mocks_result_demo';;
