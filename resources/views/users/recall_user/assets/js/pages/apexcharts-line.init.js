...
var chart, data = generateDayWiseTimeSeries(new Date("11 Feb 2017").getTime(), 185, {min: 30, max: 90}),
    ...
    }, (chart = new ApexCharts(document.querySelector("#line_chart_missing_data"), options)).render()), 0), data = [],
    TICKINTERVAL = 864e5, XAXISRANGE = 7776e5;
...
var optionsLine, chartLine, optionsLine2, chartLine2, optionsArea, chartArea,
