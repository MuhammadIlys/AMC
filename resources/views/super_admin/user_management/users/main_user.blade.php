            ...
            populateCountries();
                    ...
                    function initializeDataTable() {
                        return $('#user_table').DataTable({
                            ajax: '/get_user_data', // Update the URL to fetch user data
                            columns: [
...

                                {
                                    ...
                                    render: function (data, type, row) {
                                        return `
                                            ...
                                            <button class="subscription-btn btn-success btn btn-sm mb-1 waves-effect waves-light " data-id="${data.id}">Add Subscription</button>
                                        `;
                                    }
                                }
                            ],
...
//########################################################################################
        ...
        $('#user_table').on('click', '.subscription-btn', function () {
            ...
            var url = '/add_subscription_to_user?id=' + id;
