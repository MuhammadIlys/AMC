        ...
        <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Recalls Questions</h5>
                                    </div>
...
$(document).ready(function () {
    ...
    function initializeDataTable() {
        return $('#question_table').DataTable({
            ...
            ajax: '/load_recalls_question_to_table',
            columns: [
                {
        ...
        $('#question_table').on('click', '.edit-btn', function () {
            ...
            $.ajax({
                ...
                url: `/edit_recall_question_loader/${questionId}`, // Updated URL
                method: 'GET',
                dataType: 'json',
                success: function(data) {
        ...
        // Show a confirmation dialog using SweetAlert
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '/delete_recalls_question/' + question_id, // Adjust the URL to your delete route
                            type: 'DELETE',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
